...
splitter = ":"
while True:
    splitterindex = stockprice.find(splitter)

    if splitterindex == -1:
        listoffloats.append(stockprice)
        break

    listoffloats.append(stockprice[0:splitterindex])

    stockprice = stockprice[splitterindex + 1:]
