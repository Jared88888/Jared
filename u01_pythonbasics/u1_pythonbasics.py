...
# Exercise 1: Variables and Assignmentsir sum.
# Ex
# Assign values to variables and calculate theample: Assign 10 to a and 20 to b. Calculate their sum.
print("Hello World")
x = 10
y = 20
z = x + y
...
full_name = first_name + " " + last_name  #Getting the full name
print("Welcome, " + full_name + "!")  #Welcoming them by their full name
...
name = "Alice"
hobby = "reading"
print(name + " loves " + hobby + " in her free time")

print("Let's go! " * 3 + "We can do it!")
